...
public class ReadonlyMsadUserAccountControlStorageMapperFactory extends AbstractLDAPStorageMapperFactory {

    public static final String PROVIDER_ID = "my-custom-ldap-mapper";
    ...
    private static List<ProviderConfigProperty> getConfigProps(ComponentModel parent) {
        return ProviderConfigurationBuilder.create()
                .property().name(ReadonlyMsadUserAccountControlStorageMapper.LDAP_PASSWORD_POLICY_HINTS_ENABLED)
    ...
    protected AbstractLDAPStorageMapper createMapper(ComponentModel mapperModel, LDAPStorageProvider federationProvider) {
        return new ReadonlyMsadUserAccountControlStorageMapper(mapperModel, federationProvider);
    }
}